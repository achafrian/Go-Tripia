 ...
 */
public class TwoDay extends javax.swing.JFrame {
    ...
    public TwoDay() {
        ...
        //Data Paket 2 Day
        String[] judul2 = {"Nama Pemesan","Pulau","Tanggal","Paket Harga"};
        model = new DefaultTableModel(judul2, 0);
        tabeldata_day2.setModel(model);
        tabelday2();
    }
    ...
    private void initComponents() {
        ...
        tabeldata_day2 = new javax.swing.JTable();
        ...
        jLabel4.setText("PAKET 2 DAY");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(284, 27, 211, 40);

        tabeldata_day2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabeldata_day2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabeldata_day2MouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabeldata_day2);
        ...
        combo_paketharga.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Paket 1 [200K]", "Paket 2 [300K]", "Paket 3 [400K]" }));
    ...
    private void bt_pesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_pesanActionPerformed
        // TODO add your handling code here:
        try {
            ontw.setNama(txt_nama.getText());
            ontw.setPulau(combo_pulau.getSelectedItem().toString());
            ontw.setTanggal(txt_tanggal.getText());
            ontw.setPaketharga(combo_paketharga.getSelectedItem().toString());
    ...
    private void tabeldata_day2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabeldata_day2MouseClicked
        // TODO add your handling code here:
        // menampilkan data kedalam form pengisian:
        int baris = tabeldata_day2.getSelectedRow();
        if(baris > -1){
        String nama = tabeldata_day2.getValueAt(baris, 0).toString();
        txt_nama.setText(nama);
        String pulau = tabeldata_day2.getValueAt(baris,1).toString();
        combo_pulau.setSelectedItem(pulau);
        String tanggal = tabeldata_day2.getValueAt(baris, 2).toString();
        txt_tanggal.setText(tanggal);
        String paketharga = tabeldata_day2.getValueAt(baris, 3).toString();
        combo_paketharga.setSelectedItem(paketharga);
        }
    }//GEN-LAST:event_tabeldata_day2MouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TwoDay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tabeldata_day2;
