 ...
 */
public class ThreeDay extends javax.swing.JFrame {
    ...
    public ThreeDay() {
        ...
        //Data Paket 3 Day
        String[] judul3 = {"Nama Pemesan","Pulau","Tanggal","Paket Harga"};
        model = new DefaultTableModel(judul3, 0);
        tabeldata_day3.setModel(model);
        tabelday3();
    }
    ...
    private void initComponents() {
        ...
        tabeldata_day3 = new javax.swing.JTable();
        ...
        bt_kembali.setBounds(585, 487, 110, 40);
        ...
        bt_perbarui.setBounds(48, 487, 110, 40);
        ...
        bt_hapus.setBounds(169, 487, 110, 40);
        ...
        bt_pesan.setBounds(585, 293, 110, 40);
        ...
        bt_checkout.setBounds(291, 487, 110, 40);

        jLabel4.setFont(new java.awt.Font("Tw Cen MT", 1, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("PAKET 3 DAY");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(284, 27, 211, 40);

        tabeldata_day3.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabeldata_day3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabeldata_day3MouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabeldata_day3);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(48, 346, 647, 128);

        jLabel1.setFont(new java.awt.Font("Tw Cen MT", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Pulau");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(47, 145, 75, 27);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(47, 194, 83, 27);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(47, 239, 124, 27);

        combo_paketharga.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        combo_paketharga.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Paket 1 [300K]", "Paket 2 [400K]", "Paket 3 [500K]" }));
        jPanel1.add(combo_paketharga);
        combo_paketharga.setBounds(225, 239, 165, 35);

        txt_tanggal.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel1.add(txt_tanggal);
        txt_tanggal.setBounds(225, 190, 165, 36);
        ...
        combo_pulau.setBounds(225, 141, 165, 36);
    ...
    private void bt_pesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_pesanActionPerformed
        // TODO add your handling code here:
        try {
            onth.setNama(txt_nama.getText());
            onth.setPulau(combo_pulau.getSelectedItem().toString());
            onth.setTanggal(txt_tanggal.getText());
            onth.setPaketharga(combo_paketharga.getSelectedItem().toString());
    ...
    private void bt_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_hapusActionPerformed
        // TODO add your handling code here:
        try {
            String sql ="DELETE FROM day3";
            java.sql.Connection conn=(Connection)koneksi.koneksiDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(this, "Pesanan Anda Telah Dihapus!", "Message", JOptionPane.WARNING_MESSAGE);
        } catch (Exception e) {
    ...
    private void tabeldata_day3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabeldata_day3MouseClicked
        // TODO add your handling code here:
        // menampilkan data kedalam form pengisian:
        int baris = tabeldata_day3.getSelectedRow();
        if(baris > -1){
        String nama = tabeldata_day3.getValueAt(baris, 0).toString();
        txt_nama.setText(nama);
        String pulau = tabeldata_day3.getValueAt(baris,1).toString();
        combo_pulau.setSelectedItem(pulau);
        String tanggal = tabeldata_day3.getValueAt(baris, 2).toString();
        txt_tanggal.setText(tanggal);
        String paketharga = tabeldata_day3.getValueAt(baris, 3).toString();
        combo_paketharga.setSelectedItem(paketharga);
        }
    }//GEN-LAST:event_tabeldata_day3MouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThreeDay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tabeldata_day3;
